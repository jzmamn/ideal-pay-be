-- ============================================================
--  Email Setup — email_config + email_template
--  MySQL 8.0  |  Run on an existing ideal_pay database
--  (usr table must already exist)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS email_template (
    ...
    email_config_id  BIGINT        NULL                      COMMENT 'Optional — NULL means use the active config',
    subject          VARCHAR(500)  NOT NULL                  COMMENT 'Supports {{variables}}',
...
-- ── 3. Seed: starter email templates ─────────────────────────────────────────
