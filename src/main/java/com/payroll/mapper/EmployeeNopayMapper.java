...
public interface EmployeeNopayMapper {
    ...
    @Mapping(target = "nopay",   ignore = true)
    ...
    @Mapping(target = "nopayId",            source = "nopay.id")
    @Mapping(target = "nopayCode",          source = "nopay.code")
    @Mapping(target = "nopayName",          source = "nopay.name")
    @Mapping(target = "nopayMasterDays",    ignore = true)
