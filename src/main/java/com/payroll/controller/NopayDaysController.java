...
public class NopayDaysController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponseDTO<List<NopayDaysResponseDTO>>> getAllNopayDays(@RequestParam(value = "showDefaultRow", defaultValue = "false") boolean showDefaultRow, @RequestParam(value = "isActive", defaultValue = "all") String isActive) {
